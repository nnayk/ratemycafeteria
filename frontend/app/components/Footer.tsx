      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <Link href="/faqs" className="text-black hover:text-yellow-500 transition duration-300">
            ...
            <a href="https://www.buymeacoffee.com/ratemycafeteria" target="_blank" rel="noopener noreferrer" className="text-black hover:text-yellow-500 transition duration-300">
              Buy me a coffee
            </a>
          </div>
